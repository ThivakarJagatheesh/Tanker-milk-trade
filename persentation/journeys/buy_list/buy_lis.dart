...
import 'package:dairy_products/persentation/journeys/buy_list_detail/buy_list_detail.dart';
...
class BuyListWidget extends StatefulWidget {
  ...
  @override
  State<BuyListWidget> createState() => _BuyListWidgetState();
}
    ...
    return Scaffold(
      ...
      body: BlocProvider.value(
          ...
          child: BlocConsumer<ProductBloc, ProductState>(
            ...
            return buyList(shellBuyBody);
          })),
      floatingActionButton: FloatingActionButton(
        backgroundColor: const Color.fromARGB(255, 24, 97, 156),
        onPressed: () {
          var route = MaterialPageRoute(builder: (_) => const BuyPostPage());
          Navigator.push(context, route)
              .whenComplete(() => productBloc.getProductList());
        },
        child: const Icon(
          Icons.add,
        ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      //       TextSpan(
                      //           text: shellBuyBody[index].productTypeName ??
                      //               'BULK MILK',
                      ...
                      //           style: TextStyle(color: Colors.grey)),
                      //       TextSpan(
                      //           text: shellBuyBody[index].subProducttypeName ??
                      //               '',
                      //           style: const TextStyle(color: Colors.black)),
                      //     ])),
                      //     const SizedBox(
                      ...
                      //           style: TextStyle(color: Colors.grey)),
                      //       TextSpan(
                      //           text: shellBuyBody[index].postType ?? '',
                      //           style: const TextStyle(color: Colors.black)),
                      //     ])),
                      //     const SizedBox(
                      //       height: 10,
